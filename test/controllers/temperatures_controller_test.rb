...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { date: @temperature.date, maximum_temperature: @temperature.maximum_temperature, minimum_temperature: @temperature.minimum_temperature, time: @temperature.time } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { date: @temperature.date, maximum_temperature: @temperature.maximum_temperature, minimum_temperature: @temperature.minimum_temperature, time: @temperature.time } }
